...
# python predict_crop_all.py --video monodepth2/gggg.avi --monodepth2_model_name mono+stereo_640x192 --pred_metric_depth
...
if __name__ == '__main__':
    ...
    while(cap.isOpened()):
        ...
        if ret == True:
            ...
            if first:
                out = cv2.VideoWriter('outpy.avi',cv2.VideoWriter_fourcc('M','J','P','G'), 20, (frame.shape[1],frame.shape[0]),1)
                first=False
